...
class SiteContentSeeder extends Seeder
{
    ...
    private function seedSettings(): void
    {
        $settings = [
            ...
            ['key' => 'materials_section_eyebrow', 'value' => 'Materials', 'type' => 'string', 'group' => 'materials_section'],
            ['key' => 'materials_section_heading', 'value' => 'Start with the right surface.', 'type' => 'string', 'group' => 'materials_section'],
            ['key' => 'materials_section_subheading', 'value' => 'Explore our most requested natural and engineered surfaces. Each offers its own balance of character, durability, performance, and design possibilities. Select a material below to learn more about its characteristics, applications, and care. Looking for something different? Additional materials are available by special order.', 'type' => 'string', 'group' => 'materials_section'],
            ['key' => 'materials_products_eyebrow', 'value' => 'Materials', 'type' => 'string', 'group' => 'materials_section'],
            ['key' => 'materials_products_heading', 'value' => 'Explore Our Materials', 'type' => 'string', 'group' => 'materials_section'],
            ['key' => 'materials_products_subheading', 'value' => 'Explore our most requested natural and engineered surfaces. Each offers its own balance of character, durability, performance, and design possibilities. Select a material below to learn more about its characteristics, applications, and care. Looking for something different? Additional materials are available by special order.', 'type' => 'string', 'group' => 'materials_section'],
            ['key' => 'materials_callout_eyebrow', 'value' => 'Additional Materials', 'type' => 'string', 'group' => 'materials_section'],
            ['key' => 'materials_callout_heading', 'value' => 'Beyond the Core Collection', 'type' => 'string', 'group' => 'materials_section'],
            ['key' => 'materials_callout_body', 'value' => 'Creative Granite + Design also works with porcelain and can special order additional surface materials based on the needs of the project. If a client is looking for a specific material or application, our team can help explore available options.', 'type' => 'string', 'group' => 'materials_section'],
            ['key' => 'materials_callout_button_label', 'value' => 'Contact Us', 'type' => 'string', 'group' => 'materials_section'],
            ['key' => 'materials_callout_button_url', 'value' => '/contact', 'type' => 'string', 'group' => 'materials_section'],
            ['key' => 'remnants_cta_heading', 'value' => 'Explore Available Remnants', 'type' => 'string', 'group' => 'remnants'],
            ['key' => 'remnants_cta_body', 'value' => 'Looking for a beautiful stone for a smaller project? Explore our available remnants and find the perfect piece for your project.', 'type' => 'string', 'group' => 'remnants'],
            ['key' => 'remnants_cta_button_label', 'value' => 'Explore Remnants', 'type' => 'string', 'group' => 'remnants'],
            ['key' => 'remnants_cta_button_url', 'value' => '/remnants', 'type' => 'string', 'group' => 'remnants'],
            ['key' => 'remnants_page_heading', 'value' => 'Available Remnants', 'type' => 'string', 'group' => 'remnants'],
            ['key' => 'remnants_page_subheading', 'value' => 'Explore our selection of available stone remnants for smaller projects and custom applications.', 'type' => 'string', 'group' => 'remnants'],
            ['key' => 'remnants_coming_soon_heading', 'value' => 'Available Remnants — Coming Soon', 'type' => 'string', 'group' => 'remnants'],
            ['key' => 'remnants_coming_soon_body', 'value' => "We're currently organizing our remnant inventory and photography. Please check back soon to explore available pieces.", 'type' => 'string', 'group' => 'remnants'],
            ['key' => 'products_page_eyebrow', 'value' => 'Products', 'type' => 'string', 'group' => 'products_page'],
            ['key' => 'products_page_heading', 'value' => 'Sink Selections', 'type' => 'string', 'group' => 'products_page'],
            ['key' => 'products_page_subheading', 'value' => 'Explore stainless steel, porcelain, fireclay, and quartz composite sinks with full specifications for every model.', 'type' => 'string', 'group' => 'products_page'],
    ...
    private function seedServicesPage(): void
    {
        $settings = [
            ...
            ['key' => 'services_page_show_warranty_card', 'value' => '1', 'type' => 'string', 'group' => 'services_page'],
            ...
            ['key' => 'services_page_show_repairs_card', 'value' => '1', 'type' => 'string', 'group' => 'services_page'],
