...
class SiteContentSeeder extends Seeder
{
    ...
    private function seedSettings(): void
    {
        $settings = [
            ...
            ['key' => 'materials_products_subheading', 'value' => 'Explore our most requested natural and engineered surfaces. Each offers its own balance of character, durability, and performance.', 'type' => 'string', 'group' => 'materials_section'],
