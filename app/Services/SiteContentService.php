    ...
    private function staticSections(): array
    {
        ...
        $sections = [
            ...
            'materials' => [
                ...
                'heading' => $settings['materials_section_heading'] ?? 'Start with the right surface.',
                'subheading' => $settings['materials_section_subheading'] ?? 'Explore our most requested natural and engineered surfaces. Each offers its own balance of character, durability, performance, and design possibilities. Select a material below to learn more about its characteristics, applications, and care. Looking for something different? Additional materials are available by special order.',
                'body' => '',
                'highlightText' => '',
                'image' => '',
            ],
            'materials-products' => [
                ...
                'subheading' => $settings['materials_products_subheading'] ?? 'Explore our most requested natural and engineered surfaces. Each offers its own balance of character, durability, performance, and design possibilities. Select a material below to learn more about its characteristics, applications, and care. Looking for something different? Additional materials are available by special order.',
                'body' => '',
                'highlightText' => '',
                'image' => '',
            ],
