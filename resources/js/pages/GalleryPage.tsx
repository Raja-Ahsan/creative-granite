...
export function GalleryPage() {
  ...
  const projects = useMemo(
    () => galleryAlbums.filter((album) => album.kind === "project"),
    [galleryAlbums],
  );
        ...
        <section className="relative overflow-hidden bg-cream pb-12 pt-[calc(4.25rem+5rem)] md:pb-16 md:pt-[calc(6.5rem+7rem)]">
          ...
          <div className="relative mx-auto max-w-[1400px] px-6 md:px-10">
            <Reveal>
              ...
              <h1 className={`mt-6 max-w-4xl ${sectionHeadingLight}`}>{intro.heading}</h1>
              {intro.body && <p className={`mt-8 max-w-2xl ${bodyCopyLight}`}>{intro.body}</p>}
            </Reveal>
          </div>
        </section>
            ...
            <div className="relative mx-auto max-w-[1400px] px-6 md:px-10">
              <Reveal>
                <div className="flex items-center gap-3 text-cream/50">
                  ...
                  <span className="eyebrow text-cream/50">{featuredSection.eyebrow}</span>
                </div>
