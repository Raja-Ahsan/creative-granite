    ...
    <div class="grid grid-cols-1 gap-6 lg:grid-cols-3">
        <div class="lg:col-span-2 space-y-6">
            <div class="bg-white shadow sm:rounded-lg">
                <div class="border-b border-gray-200 px-6 py-4">
                    <h2 class="text-sm font-semibold uppercase tracking-[0.14em] text-gray-700">Message</h2>
                </div>
                <div class="p-6">
                    <p class="whitespace-pre-wrap text-sm leading-relaxed text-gray-800">{{ $inquiry->message }}</p>
                </div>
            </div>
        </div>
        ...
        <div class="space-y-6">
            <div class="bg-white shadow sm:rounded-lg">
                ...
                <dl class="divide-y divide-gray-100 px-6 py-2 text-sm">
                    <div class="py-3">
                        ...
                        <dd class="mt-1 font-medium text-gray-900">{{ $inquiry->name }}</dd>
                    </div>
                    <div class="py-3">
                    ...
                    @if ($inquiry->phone)
                        <div class="py-3">
                            ...
                            <dd class="mt-1">
                                <a href="tel:{{ $inquiry->phone }}" class="text-indigo-600 hover:text-indigo-800">{{ $inquiry->phone }}</a>
                            </dd>
                        </div>
                    @endif
                    <div class="py-3">
                        <dt class="text-xs uppercase tracking-wider text-gray-500">Project Type</dt>
                        <dd class="mt-1 text-gray-900">{{ $inquiry->projectTypeLabel() }}</dd>
                    </div>
                    <div class="py-3">
                        <dt class="text-xs uppercase tracking-wider text-gray-500">Received</dt>
                        <dd class="mt-1 text-gray-900">{{ $inquiry->created_at->format('l, F j, Y \a\t g:i A') }}</dd>
                    </div>
                </dl>
            </div>
            ...
            <div class="flex flex-wrap gap-3">
                <a
                    href="mailto:{{ $inquiry->email }}?subject={{ rawurlencode('Re: Your Creative Granite enquiry') }}"
